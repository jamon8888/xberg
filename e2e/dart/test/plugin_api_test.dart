...
class TestStubRegisterDocumentExtractorTraitBridge extends DocumentExtractor {
  ...
  Future<ExtractionResult> extractBytes(Uint8List content, String mimeType, ExtractionConfig config) async => ExtractionResult();
  Future<ExtractionResult> extractFile(String path, String mimeType, ExtractionConfig config) async => ExtractionResult();
