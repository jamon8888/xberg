...
final class NativeLib {
    ...
    static final MethodHandle XBERG_CUSTOM_SOURCE_FROM_PARTS = LIB.find("xberg_custom_source_from_parts")
    ...
    static final MethodHandle XBERG_CUSTOM_GLINER_SOURCE_TO_JSON = LIB.find("xberg_custom_gliner_source_to_json")
        .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
        .orElse(null);
