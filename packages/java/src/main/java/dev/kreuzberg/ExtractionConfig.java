...
// alef:hash:f7cb8b91544f3f77e69e41e62706a5d4e992f2849b74ef40518aa8bb5e25b169
...
private Boolean enableQualityProcessing = null;
        @Nullable private Optional<OcrConfig> ocr = Optional.empty();
...
private Boolean disableOcr = null;
        @Nullable private Optional<ChunkingConfig> chunking = Optional.empty();
        @JsonProperty("content_filter")
        @Nullable private Optional<ContentFilterConfig> contentFilter = Optional.empty();
        @Nullable private Optional<ImageExtractionConfig> images = Optional.empty();
        @JsonProperty("pdf_options")
        @Nullable private Optional<PdfConfig> pdfOptions = Optional.empty();
        @JsonProperty("token_reduction")
        @Nullable private Optional<TokenReductionOptions> tokenReduction = Optional.empty();
        @JsonProperty("language_detection")
        @Nullable private Optional<LanguageDetectionConfig> languageDetection = Optional.empty();
        @Nullable private Optional<PageConfig> pages = Optional.empty();
        @Nullable private Optional<KeywordConfig> keywords = Optional.empty();
        @Nullable private Optional<PostProcessorConfig> postprocessor = Optional.empty();
        @JsonProperty("html_options")
private Optional<String> htmlOptions = Optional.empty();
        @JsonProperty("html_output")
        @Nullable private Optional<HtmlOutputConfig> htmlOutput = Optional.empty();
...
private Optional<Long> maxConcurrentExtractions = Optional.empty();
        ...
        @Nullable private Optional<SecurityLimits> securityLimits = Optional.empty();
        @JsonProperty("output_format")
        @Nullable private OutputFormat outputFormat = OutputFormat.Plain;
        @Nullable private Optional<LayoutDetectionConfig> layout = Optional.empty();
...
private Optional<Long> cacheTtlSecs = Optional.empty();
        @Nullable private Optional<EmailConfig> email = Optional.empty();
...
private Long maxArchiveDepth = null;
        ...
        @Nullable private Optional<TreeSitterConfig> treeSitter = Optional.empty();
        @JsonProperty("structured_extraction")
        @Nullable private Optional<StructuredExtractionConfig> structuredExtraction = Optional.empty();
