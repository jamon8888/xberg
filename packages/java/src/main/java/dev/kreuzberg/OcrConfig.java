...
// alef:hash:5706f4d46556e746bdbbd71073c305804dfc3f9a0ccd0e091de4d0d32148e71f
...
private String language = null;
        ...
        @Nullable private Optional<TesseractConfig> tesseractConfig = Optional.empty();
        @JsonProperty("output_format")
        @Nullable private Optional<OutputFormat> outputFormat = Optional.empty();
...
private Optional<Object> backendOptions = Optional.empty();
        ...
        @Nullable private Optional<OcrElementConfig> elementConfig = Optional.empty();
        @JsonProperty("quality_thresholds")
        @Nullable private Optional<OcrQualityThresholds> qualityThresholds = Optional.empty();
        @Nullable private Optional<OcrPipelineConfig> pipeline = Optional.empty();
        @JsonProperty("auto_rotate")
private Boolean autoRotate = null;
        @JsonProperty("vlm_config")
        @Nullable private Optional<LlmConfig> vlmConfig = Optional.empty();
