...
// alef:hash:45bd9afb4cdb33568e061e753c9848cf30057c276f3f4907197d455cbcfd8ce2
...
private Metadata metadata = null;
        ...
        @Nullable private Optional<ExtractionMethod> extractionMethod = Optional.empty();
...
private Optional<List<Element>> elements = Optional.empty();
        ...
        @Nullable private Optional<DjotContent> djotContent = Optional.empty();
        @JsonProperty("ocr_elements")
private Optional<List<OcrElement>> ocrElements = Optional.empty();
        @Nullable private Optional<DocumentStructure> document = Optional.empty();
