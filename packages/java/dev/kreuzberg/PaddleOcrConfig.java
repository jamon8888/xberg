...
public record PaddleOcrConfig(
    ...
    public static final class Builder {
        ...
        private final float detDbThresh;
        /** detDbBoxThresh. */
        @JsonProperty("det_db_box_thresh")
        private final float detDbBoxThresh;
        /** detDbUnclipRatio. */
        @JsonProperty("det_db_unclip_ratio")
        private final float detDbUnclipRatio;
        /** detLimitSideLen. */
        @JsonProperty("det_limit_side_len")
        private final int detLimitSideLen;
        /** recBatchNum. */
        @JsonProperty("rec_batch_num")
        private final int recBatchNum;
        /** padding. */
        private final int padding;
        /** dropScore. */
        @JsonProperty("drop_score")
        private final float dropScore;
        /** modelTier. */
