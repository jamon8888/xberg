...
public record ExtractionConfig(
    ...
    public static final class Builder {
        ...
        /** ocr. */
        @Nullable         private final OcrConfig ocr;
        /** forceOcr. */
        @JsonProperty("force_ocr")
        private final Boolean forceOcr;
        /** forceOcrPages. */
        @JsonProperty("force_ocr_pages")
        private final List<Integer> forceOcrPages;
        /** disableOcr. */
        @JsonProperty("disable_ocr")
        private final Boolean disableOcr;
        /** chunking. */
        @Nullable         private final ChunkingConfig chunking;
        /** contentFilter. */
        @JsonProperty("content_filter")
        @Nullable         private final ContentFilterConfig contentFilter;
        /** images. */
        @Nullable         private final ImageExtractionConfig images;
        /** pdfOptions. */
        @JsonProperty("pdf_options")
        @Nullable         private final PdfConfig pdfOptions;
        /** tokenReduction. */
        @JsonProperty("token_reduction")
        @Nullable         private final TokenReductionOptions tokenReduction;
        /** languageDetection. */
        @JsonProperty("language_detection")
        @Nullable         private final LanguageDetectionConfig languageDetection;
        /** pages. */
        @Nullable         private final PageConfig pages;
        /** keywords. */
        @Nullable         private final KeywordConfig keywords;
        /** postprocessor. */
        @Nullable         private final PostProcessorConfig postprocessor;
        /** htmlOutput. */
        @JsonProperty("html_output")
        @Nullable         private final HtmlOutputConfig htmlOutput;
        ...
        private final Long maxConcurrentExtractions;
        /** resultFormat. */
        @JsonProperty("result_format")
        @Nullable         private final ResultFormat resultFormat = ResultFormat.Unified;
        /** securityLimits. */
        @JsonProperty("security_limits")
        @Nullable         private final SecurityLimits securityLimits;
        /** maxEmbeddedFileBytes. */
        @JsonProperty("max_embedded_file_bytes")
        private final Long maxEmbeddedFileBytes;
        /** outputFormat. */
        @JsonProperty("output_format")
        @Nullable         private final OutputFormat outputFormat = OutputFormat.Plain;
        /** layout. */
        @Nullable         private final LayoutDetectionConfig layout;
        /** transcription. */
        @Nullable         private final TranscriptionConfig transcription;
        /** useLayoutForMarkdown. */
        @JsonProperty("use_layout_for_markdown")
        private final Boolean useLayoutForMarkdown;
        ...
        /** email. */
        @Nullable         private final EmailConfig email;
        /** maxArchiveDepth. */
        @JsonProperty("max_archive_depth")
        private final Long maxArchiveDepth;
        /** treeSitter. */
        @JsonProperty("tree_sitter")
        @Nullable         private final TreeSitterConfig treeSitter;
        /** structuredExtraction. */
        @JsonProperty("structured_extraction")
        @Nullable         private final StructuredExtractionConfig structuredExtraction;
        /** ner. */
        @Nullable         private final NerConfig ner;
        /** redaction. */
        @Nullable         private final RedactionConfig redaction;
        /** summarization. */
        @Nullable         private final SummarizationConfig summarization;
        /** translation. */
        @Nullable         private final TranslationConfig translation;
        /** pageClassification. */
        @JsonProperty("page_classification")
        @Nullable         private final PageClassificationConfig pageClassification;
        /** captioning. */
        @Nullable         private final CaptioningConfig captioning;
        /** qrCodes. */
