...
public record TokenReductionConfig(
    ...
    public static final class Builder {
        ...
        /** level. */
        private final ReductionLevel level;
        /** languageHint. */
        @JsonProperty("language_hint")
        private final String languageHint;
        /** preserveMarkdown. */
        @JsonProperty("preserve_markdown")
        private final boolean preserveMarkdown;
        /** preserveCode. */
        @JsonProperty("preserve_code")
        private final boolean preserveCode = true;
        /** semanticThreshold. */
        @JsonProperty("semantic_threshold")
        private final float semanticThreshold;
        /** enableParallel. */
        @JsonProperty("enable_parallel")
        private final boolean enableParallel = true;
        /** useSimd. */
        @JsonProperty("use_simd")
        private final boolean useSimd = true;
        /** customStopwords. */
        @JsonProperty("custom_stopwords")
        private final Map<String, List<String>> customStopwords;
        /** preservePatterns. */
        @JsonProperty("preserve_patterns")
        private final List<String> preservePatterns = List.of();
        /** targetReduction. */
        @JsonProperty("target_reduction")
        private final Float targetReduction;
