...
public record ImagePreprocessingMetadata(
    ...
    public static final class Builder {
        ...
        private final boolean autoAdjusted;
        /** finalDpi. */
        @JsonProperty("final_dpi")
        private final int finalDpi;
        /** resampleMethod. */
        @JsonProperty("resample_method")
        private final String resampleMethod;
        /** dimensionClamped. */
        @JsonProperty("dimension_clamped")
        private final boolean dimensionClamped;
        /** calculatedDpi. */
        @JsonProperty("calculated_dpi")
        private final Integer calculatedDpi;
        /** skippedResize. */
        @JsonProperty("skipped_resize")
        private final boolean skippedResize;
        /** resizeError. */
        @JsonProperty("resize_error")
        private final String resizeError;
