...
public record OcrConfig(
    ...
    public static final class Builder {
        ...
        @Nullable         private final TesseractConfig tesseractConfig;
        /** outputFormat. */
        @JsonProperty("output_format")
        @Nullable         private final OutputFormat outputFormat;
        /** paddleOcrConfig. */
        @JsonProperty("paddle_ocr_config")
        private final Object paddleOcrConfig;
        /** backendOptions. */
        @JsonProperty("backend_options")
        private final Object backendOptions;
        /** elementConfig. */
        @JsonProperty("element_config")
        @Nullable         private final OcrElementConfig elementConfig;
        /** qualityThresholds. */
        @JsonProperty("quality_thresholds")
        @Nullable         private final OcrQualityThresholds qualityThresholds;
        /** pipeline. */
        @Nullable         private final OcrPipelineConfig pipeline;
        /** autoRotate. */
        @JsonProperty("auto_rotate")
        private final Boolean autoRotate;
        /** vlmFallback. */
        @JsonProperty("vlm_fallback")
        @Nullable         private final VlmFallbackPolicy vlmFallback = new VlmFallbackPolicy.Disabled();
        /** vlmConfig. */
        @JsonProperty("vlm_config")
        @Nullable         private final LlmConfig vlmConfig;
        /** vlmPrompt. */
        @JsonProperty("vlm_prompt")
        private final String vlmPrompt;
        /** acceleration. */
        private final AccelerationConfig acceleration;
        /** tessdataBytes. */
        @JsonProperty("tessdata_bytes")
        private final Map<String, byte[]> tessdataBytes;
