...
public record HtmlMetadata(
    ...
    public static final class Builder {
        ...
        private final Map<String, String> openGraph;
        /** twitterCard. */
        @JsonProperty("twitter_card")
        private final Map<String, String> twitterCard;
        /** metaTags. */
        ...
        /** images. */
        private final List<ImageMetadataType> images;
        /** structuredData. */
        @JsonProperty("structured_data")
        private final List<StructuredData> structuredData;
