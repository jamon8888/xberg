...
public record TesseractConfig(
    ...
    public static final class Builder {
        ...
        private final String tesseditCharBlacklist;
        /** tesseditUsePrimaryParamsModel. */
        @JsonProperty("tessedit_use_primary_params_model")
        private final boolean tesseditUsePrimaryParamsModel = true;
        /** textordSpaceSizeIsVariable. */
        @JsonProperty("textord_space_size_is_variable")
        private final boolean textordSpaceSizeIsVariable = true;
        /** thresholdingMethod. */
        @JsonProperty("thresholding_method")
        private final boolean thresholdingMethod;
