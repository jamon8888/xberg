...
public record ModelPaths(
    ...
    public static final class Builder {
        ...
        private final java.nio.file.Path detModel;
        /** clsModel. */
        @JsonProperty("cls_model")
        private final java.nio.file.Path clsModel;
        /** recModel. */
        @JsonProperty("rec_model")
        private final java.nio.file.Path recModel;
        /** dictFile. */
        @JsonProperty("dict_file")
        private final java.nio.file.Path dictFile;
