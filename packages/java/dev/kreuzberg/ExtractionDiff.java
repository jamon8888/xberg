...
public record ExtractionDiff(
    ...
    public static final class Builder {
        ...
        private final List<DiffHunk> contentDiff = List.of();
        /** tablesAdded. */
        @JsonProperty("tables_added")
        private final List<Table> tablesAdded = List.of();
        /** tablesRemoved. */
        @JsonProperty("tables_removed")
        private final List<Table> tablesRemoved = List.of();
        /** tablesChanged. */
        @JsonProperty("tables_changed")
        private final List<TableDiff> tablesChanged = List.of();
        /** metadataChanged. */
        @JsonProperty("metadata_changed")
        private final Object metadataChanged;
        /** embeddedChanges. */
        @JsonProperty("embedded_changes")
        private final EmbeddedChanges embeddedChanges;
