...
public sealed class VlmFallbackPolicyJsonConverter : JsonConverter<VlmFallbackPolicy>
{
    public override VlmFallbackPolicy Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return tagValue switch
        {
            ...
            "on_low_quality" => JsonSerializer.Deserialize<VlmFallbackPolicy.OnLowQuality>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "always" => new VlmFallbackPolicy.Always(),            // Unknown discriminator: forward compatibility for unknown variants
    ...
    public override void Write(Utf8JsonWriter writer, VlmFallbackPolicy value, JsonSerializerOptions options)
    {
        ...
        switch (value)
        {
            ...
            case VlmFallbackPolicy.OnLowQuality v_onlowquality:
                tag = "on_low_quality"; inner = v_onlowquality; break;
