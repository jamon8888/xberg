...
mod ffi {
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "pageImageFromJson")]
        fn page_image_from_json(json: String) -> Result<PageImage, String>;
        ...
        #[swift_bridge(swift_name = "customGlinerSourceFromJson")]
        fn custom_gliner_source_from_json(json: String) -> Result<CustomGlinerSource, String>;
...
pub struct ProgressEvent(pub xberg::ProgressEvent);
impl ProgressEvent {
...
#[cfg(feature = "redaction-rehydrate")]
pub struct RehydrationMap(pub xberg::RehydrationMap);
...
pub fn page_image_from_json(json: String) -> Result<PageImage, String> {
...
pub fn custom_gliner_source_from_json(json: String) -> Result<CustomGlinerSource, String> {
    serde_json::from_str::<xberg::text::ner::gline::CustomGlinerSource>(&json)
        .map(CustomGlinerSource)
        .map_err(|e| e.to_string())
}
