...
data class PageClassification(
    ...
    val pageNumber: Int,
    /**
     * Labels assigned to the page. Single-label classification yields exactly one entry;
     * multi-label classification yields any subset of the configured label set.
     */
