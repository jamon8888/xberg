...
sealed class EmbeddingModelType {
     ...
     * in config. Xberg calls back into the registered backend during chunking and standalone embed
     * requests — no HuggingFace download, no ONNX Runtime requirement, no HTTP sidecar.
     *
