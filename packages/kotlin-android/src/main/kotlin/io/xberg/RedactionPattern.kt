 ...
 *
 * The pattern is compiled with the Rust `regex` crate (no look-around). Case sensitivity is encoded
 * in the pattern via the `(?i)` inline flag when `Self.case_sensitive` is `false`.
 */
