...
sealed class FormatMetadata {
    ...
    /**
     * Code (tree-sitter analyzable source). The structured analysis result is exposed via
     * `ExtractedDocument.code_intelligence`; this variant only tags the format.
     */
...
private class FormatMetadataDeserializer :
    ...
    override fun deserialize(
        ...
        return when (tag) {
            ...
            "audio" ->
                FormatMetadata.Audio(
                    ctx.readTreeAsValue<AudioMetadata>(payload, AudioMetadata::class.java)
                )
