...
data class PptxExtractionResult(
     ...
     *
     * Each `<p:cm>` element in `ppt/comments/comment{N}.xml` becomes a `DocumentRevision { kind:
     * Comment }` with author (resolved from `ppt/commentAuthors.xml`), ISO-8601 timestamp, and
