 ...
 *
 * This struct holds all configuration options for the Xberg API server, including host/port
...
data class ServerConfig(
     ...
     *
     * If this is an empty listtor, the server will accept requests from any origin. If populated
