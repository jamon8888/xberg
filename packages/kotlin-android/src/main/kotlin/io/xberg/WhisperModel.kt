...
*
* These map to published ONNX exports on Hugging Face (onnx-community or similar orgs). The actual
* filenames and repos are resolved inside the transcription engine.
*/
