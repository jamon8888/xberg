 ...
 *
 * For insertions and deletions the `content` field carries the added/removed lines as
 * `DiffLine.Added` / `DiffLine.Removed` entries. For format changes, `content` is empty — the
 * property diff is left as a TODO for a later enrichment pass.
 */
