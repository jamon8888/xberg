...
data class DocumentNode(
     ...
     *
     * Always serialised — Kotlin-Android (and any other typed binding) treats the field as
     * non-nullable, so omitting it from the JSON wire would break consumer deserialisation.
