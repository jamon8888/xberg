 ...
 *
 * All fields are `Option<T>` — `null` means "use the batch-level default." This type is used by
 * `config` and `extract_batch` to allow heterogeneous extraction settings within a single batch.
 *
 * # Excluded Fields
 *
