 ...
 *
 * The `Custom(String)` variant lets caller-supplied categories (e.g. LLM schemas) flow through
 * without losing fidelity to the consumer.
 */
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    using = EntityCategoryDeserializer::class
)
...
private class EntityCategoryDeserializer :
    com.fasterxml.jackson.databind.deser.std.StdDeserializer<EntityCategory>(
    ...
    override fun deserialize(
            ...
            return when (node.asText()) {
                ...
                "url" -> EntityCategory.Url
                    ...
                    throw com.fasterxml.jackson.databind.exc.InvalidFormatException(
                        parser,
                        "Unknown EntityCategory unit variant",
                        node.asText(),
                        EntityCategory::class.java,
                    )
            }
                ...
                if (!it.hasNext()) {
                    ...
                    return when (entry.key) {
                        "custom" ->
                            ...
                            throw com.fasterxml.jackson.databind.exc.InvalidFormatException(
                                parser,
                                "Unknown EntityCategory data variant",
                                entry.key,
                                EntityCategory::class.java,
                            )
                    }
        ...
        throw com.fasterxml.jackson.databind.exc.InvalidFormatException(
            parser,
            "Cannot deserialize EntityCategory: expected string or single-field object",
            null,
            EntityCategory::class.java,
        )
    }
...
private class EntityCategorySerializer :
    com.fasterxml.jackson.databind.ser.std.StdSerializer<EntityCategory>(
        EntityCategory::class.java
    ) {
    @Suppress("LongMethod")
