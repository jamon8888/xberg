...
data class ChunkingConfig(
     ...
     *
     * - `Split` (default) — tables are split at row boundaries; continuation chunks do not repeat
     *   the header.
     *
     * - `RepeatHeader` — the table header row and separator are prepended to every continuation
     *   chunk so each chunk is self-contained.
     *
     * Default: `Split`
     */
