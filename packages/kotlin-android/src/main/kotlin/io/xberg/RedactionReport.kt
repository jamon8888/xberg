 ...
 *
 * The redactor returns this alongside the rewritten content so compliance, replay, and audit-log
 * consumers can see exactly what fired. Offsets are relative to the *original* pre-redaction
 * `content` and are intended for audit reconstruction only — the original bytes are dropped at the
 * end of the pipeline.
 */
