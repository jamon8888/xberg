...
data class EmbeddedFile(
     ...
     *
     * Used by callers to compute the decompression ratio and detect zip-bomb-style attacks that
     * embed a tiny compressed stream expanding to gigabytes of data.
     */
