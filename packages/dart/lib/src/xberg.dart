...
class XbergBridge {
  ...
  static Future<ExtractionResult> extract(
    ...
    return await rust_bridge.extract(
      input: input,
      config:
      config ??
      ExtractionConfig(
        ...
        url: UrlExtractionConfig(
          ...
          crawl: CrawlConfig(
            ...
            followDocumentUrls: false,
            documentUrlDepth: null,
            downloadDocuments: true,
            documentMaxSize: 52428800,
            documentMimeTypes: [],
            warcOutput: null,
            browserProfile: null,
            saveBrowserProfile: false,
            ssrf: SsrfPolicy(denyPrivate: true, maxRedirects: 5),
          ),
          documentUrlPattern: null,
          maxDocumentUrlsPerResult: 100,
          maxTotalUrls: 1000,
  ...
  /// throws anyhow::Error on failure
  static Future<ExtractionResult> extractBatch(
    List<ExtractInput> inputs, {
      ExtractionConfig? config,
  }) async {
    return await rust_bridge.extractBatch(
      inputs: inputs,
      config:
      config ??
      ExtractionConfig(
  ...
  static Future<bool> verifyExcerpt(String excerpt, String sourceText) async {
    return await rust_bridge.verifyExcerpt(
      excerpt: excerpt,
  ...
  static Future<void> registerRerankerBackend(
    RerankerBackendDartImpl impl,
  ) async {
