...
pub struct CandleBackend {
    pub(crate) inner: xberg::CandleBackend,
}

impl From<xberg::CandleBackend> for CandleBackend {
    fn from(inner: xberg::CandleBackend) -> Self {
        Self { inner }
    }
}

impl From<CandleBackend> for xberg::CandleBackend {
...
pub struct RehydrationMap {
    pub(crate) inner: xberg::RehydrationMap,
}

impl From<xberg::RehydrationMap> for RehydrationMap {
    fn from(inner: xberg::RehydrationMap) -> Self {
        Self { inner }
    }
}

impl From<RehydrationMap> for xberg::RehydrationMap {
...
impl From<xberg::ProgressEvent> for ProgressEvent {
    fn from(v: xberg::ProgressEvent) -> Self {
        ProgressEvent {
            stage: v.stage.into(),
...
impl From<xberg::ChunkerConfig> for ChunkerConfig {
    fn from(v: xberg::ChunkerConfig) -> Self {
        ChunkerConfig {
...
#[frb]
pub fn create_page_image_from_json(json: String) -> Result<PageImage, String> {
    serde_json::from_str::<xberg::engine::structured::rasterize::PageImage>(&json)
        .map(PageImage::from)
        .map_err(|e| e.to_string())
}
...
#[frb]
pub fn create_custom_gliner_source_from_json(json: String) -> Result<CustomGlinerSource, String> {
    serde_json::from_str::<xberg::text::ner::gline::CustomGlinerSource>(&json)
        .map(CustomGlinerSource::from)
        .map_err(|e| e.to_string())
}
