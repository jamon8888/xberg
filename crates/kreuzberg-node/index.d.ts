 ...
 * Returns `KreuzbergError::UnsupportedFormat` if MIME type is not supported.
 */
export declare function extractFile(path: string, mimeType?: string | undefined | null, config: ExtractionConfig): Promise<ExtractionResult>;
 ...
 */
export declare function extractFileSync(path: string, mimeType?: string | undefined | null, config: ExtractionConfig): ExtractionResult;
