...
impl CandleBackend {
    ...
    pub fn from_local(modelDir: String, loraAdapterDir: Option<String>) -> PhpResult<CandleBackend> {
        xberg::CandleBackend::from_local(
    ...
    pub fn from_bytes(
        ...
        xberg::CandleBackend::from_bytes(&safetensors.0[..], &tokenizerJson.0[..], &encoderConfigJson.0[..])
            .map(|val| Self { inner: Arc::new(val) })
            .map_err(|e| PhpException::default(e.to_string()))
    }
}
...
pub struct RehydrationMap {
    inner: Arc<xberg::RehydrationMap>,
}
...
impl From<xberg::ProgressEvent> for ProgressEvent {
    fn from(val: xberg::ProgressEvent) -> Self {
        Self {
...
impl From<xberg::ChunkerConfig> for ChunkerConfig {
    fn from(val: xberg::ChunkerConfig) -> Self {
        Self {
            max_input_tokens: val.max_input_tokens,
            avg_tokens_per_image: val.avg_tokens_per_image,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<ProgressEvent> for xberg::ProgressEvent {
