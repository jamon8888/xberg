...
// Fork-only: `process_handler` and `rehydrate_handler` (POST /v1/process and
// POST /v1/documents/{rehydration_key}/rehydrate) live in `api::rag::handlers`,
// fenced behind the `process-api` feature.
