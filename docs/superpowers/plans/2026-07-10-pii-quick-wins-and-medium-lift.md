...
- [ ] **Step 1: Add the mod-97 checksum function**
...
- [ ] **Step 2: Extract a shared filter helper in `engine.rs`**
...
- [ ] **Step 3: Validate preserve terms**
...
- [ ] **Step 1: Define the trait and `apply_validators`**
...
- [ ] **Step 2: Migrate the IBAN checksum from Task 1 into `IbanChecksumValidator`**
...
- [ ] **Step 1: `find_subject` and `forget_subject` in `rehydration.rs`**
...
- [ ] **Step 2: Tests in `rehydration.rs`**
...
- [ ] **Step 3: Corpus loader + integration test**
...
- [ ] **Step 4: Wire into CI-relevant task**
